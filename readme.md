...
* git clone - позволяет склонировать удаленный (внешний) репозиторий на ваш ПК. 

* Git push (англ. толкать) - отправляет вашу версию репозитория на удаленный репозиторий.

* Git pull (англ. тянуть) - загружает версию внешнего репозитория на локальный. 
